...
grid_locs <- readRDS("~/github/dfo/gftrends/analysis-survey/data/All_HBLL_Blocks_Area_Water.rds") %>%
...
saveRDS(nd_all, file = paste0("analysis-survey/data/nd_hbll_inside_index.rds"))
plot(nd_all)
