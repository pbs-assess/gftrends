...
We estimated the overall mean B/LRP (biomass divided by the LRP) in 2020 to be `r make_quant_text(q2021lrp)`.
The overall mean B/USR and B/B~MSY~ (biomass divided by biomass at maximum sustainable yield) in 2020 was `r make_quant_text(q2021usr)` and `r make_quant_text(q2021msy)`, respectively (Figure \@ref(fig:pa-framework), \@ref(fig:ridges)).
