...
For each stock--survey type combination, we fit both Tweedie and delta-gamma (binomial and gamma) observation error models and reported the model that produced the most precise index estimates on average; form most (XX%) stocks, this was the delta-gamma model.
