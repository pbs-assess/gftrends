...
Assessments integrate many types of data (survey indexes, ages, lengths, maturities, catches) to 
reconstruct plausible stock trajectories and estimate reference points.
...
include_graphics(here("figs/stock-vs-indices.pdf"))
```
