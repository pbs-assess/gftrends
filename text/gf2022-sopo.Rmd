...
* To assess stock status in 2021, we updated the hierarchical Bayesian state-space time-series model to include **6** newly complete stock assessments, and estimated model-based indices from the relevant surveys for all assessed stocks and those with outstanding requests for Science Advice. 
...
* Like in 2020, 4 or 5 stocks were likely in the critical zone and roughly one-third of stocks had a greater than 1 in 4 chance of being below their USR (i.e., in the "cautious zone"). Conversely, two-thirds of assessed groundfish stocks had a high (\>75%) probability of being above the USR (i.e., in the "healthy zone").
