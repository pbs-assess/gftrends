...
* We summarized groundfish stock status as of 2021 by (1) fitting
  a hierarchical Bayesian time-series model (including updated assessments for five stocks in 2021) and (2) joining model-based population indices with assessed biomass to
...
* Stock assessments classified three stocks (Strait of Georgia Lingcod [Area
  4B], inside and outside Quillback Rockfish) as having
...
* All assessed shelf rockfish (Redstripe, Bocaccio, Widow, Silvergray, Canary,
  Yellowtail) and several slope rockfish increased in surveyed biomass over the last ~5--7 years. Surveyed biomass for several flatfish
...
* Survey indices for North Pacific Spiny Dogfish stocks had the steepest
  declines across all stocks---particularly for inside Vancouver Island waters
  in 2021.
...
library(dplyr)
refpt <- readRDS("data-generated/p-thresh.rds")
ts_mcmc <- readRDS("data-generated/x_t_posterior.rds")
...
(ref:fig-ridges) Posterior distribution of the three measures of stock status for `r nrow(refs) - 2` of the `r nrow(refs)` stocks.
