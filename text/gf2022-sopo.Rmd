...
* To summarize groundfish stock status as of 2021, we (1) updated
  a hierarchical Bayesian time-series model to include five stocks with 
  updated assessments and (2) joined model-based population indices with assessed biomass to
...
The overall mean B/USR and B/B~MSY~ in 2020 was `r make_quant_text(q2021usr)` and `r make_quant_text(q2021msy)`, respectively.
...
However, the trawl survey index suggests that Arrowtooth Flounder has declined since the last assessment (Figure \@ref(fig:stock-vs-indices)).
