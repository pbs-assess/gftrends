...
(USR)---are the focus of this analysis. Based on @dfo2009. (b) Overall mean
biomass status ($x_{t}$) across all stocks for B/LRP, B/USR, and B/B~MSY~. Dark
lines represent the median, shaded ribbons represent 95% quantile credible
intervals, and thin lines represent 25 illustrative draws from the posterior
distribution.
...
Assessments integrate many types of data (survey indexes, ages, lengths, maturities, catches) to reconstruct plausible stock trajectories and estimate reference points.
