...
(REF). The USR defines the breakpoint between the healthy and cautious zone and
the LRP defines the breakpoint between the cautious and critical zone.

Scientists from the Stock Assessment and Research Division conduct regular stock
assessment of major fish stocks in BC. These assessments take into account...
and assess status with respect to reference points...
