...
The later accounts for not all stocks having an up-to-date stock assessment
...
We place half-Student-t(7, 0, 2) priors on $\sigma_{\epsilon}$ and $\sigma_{\eta}$
and a Normal(0, 1)[-1, 1] prior on $\varphi$.
We fit the models with Stan [@carpenter2017; @rstan2020], sampling 600 iterations
