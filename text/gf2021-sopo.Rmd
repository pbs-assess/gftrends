...
We group Pacific Cod and Walleye Pollock stocks to share a $\varphi$ and $\sigma_{\epsilon}$
and all other stock to share another $\varphi$ and $\sigma_{\epsilon}$ (these two stocks were
