...
2. Add any new stocks (if any) to the `analysis/stock_df.R` and `data-raw/species-regions-tofit.csv` (see [Section C](#a.-adding-and-processing-the-latest-assessment-data)). Also remove any old stocks if needed.
