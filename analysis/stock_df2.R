stock_df <- tibble::tribble(
  ...
  "canary_BC", "Canary BC", "Rockfish", "Canary Rockfish", "Coast-wide trawl surveys",
  ...
  "pacific_ocean_perch_5ABC", "Pacific Ocean Perch 5ABC", "Rockfish", "Pacific Ocean Perch", "QCS only",
  ...
  "rougheye/blackspotted_BC_South", "Rougheye/Blacksp. BC S", "Rockfish", "Rougheye/Blackspotted Rockfish Complex", "QCS & WCVI",
